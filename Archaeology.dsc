    ...
    events:
        on player right clicks block with:HC_Archaeology_Brush:
            ...
            - if <script[archaeology_data].data_key[<[block]>].exists>:
                ...
                - playeffect effect:red_dust special_data:1|<&color[#CCCCCC]> at:<context.location.center> offset:0.4 quantity:5
                - if <[BP]> >= 4:
                    - modifyblock <context.location> air
                    - playeffect effect:block_crack quantity:20 offset:0.3 at:<context.location.center> special_data:<[block]>
                    - playsound sound:BLOCK_GRASS_STEP pitch:0.75 volume:1
                    - wait 1t
